...
from main.models import Ingredients, Dish, Menu
from main.permissions import IsAuthor
from main.serializers import IngredientsSerializer, DishSerializer, DishListSerializer, MenuSerializer
...
class MenuViewSet(CreateModelMixin, UpdateModelMixin, DestroyModelMixin, GenericViewSet):
        queryset = Menu.objects.all()
        serializer_class = MenuSerializer

        # def get_permissions(self):
        #     # создавать меню может залогиненный пользователь
